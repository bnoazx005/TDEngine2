...
namespace TDEngine2
{
	...
	*/
	...
	TDE2_API IFile* CreateImageFileWriter(IMountableStorage* pStorage, TPtr<IStream> pStream, E_RESULT_CODE& result);
	...
	*/
	...
	class CImageFileWriter : public IImageFileWriter, public CBaseFile
	{
		...
		public:
			friend TDE2_API IFile* CreateImageFileWriter(IMountableStorage*, TPtr<IStream>, E_RESULT_CODE&);
		public:
			...
			*/
			...
			TDE2_API E_RESULT_CODE Write(I32 width, I32 height, I8 numOfChannels, const Vector<U8>& imageData) override;
		protected:
