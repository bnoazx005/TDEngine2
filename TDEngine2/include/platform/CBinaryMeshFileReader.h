...
namespace TDEngine2
{
	...
	*/
	...
	TDE2_API IFile* CreateBinaryMeshFileReader(IFileSystem* pFileSystem, const std::string& filename, E_RESULT_CODE& result);
	...
	*/
	...
	{
		public:
			friend TDE2_API IFile* CreateBinaryMeshFileReader(IFileSystem* pFileSystem, const std::string& filename, E_RESULT_CODE& result);
		private:
