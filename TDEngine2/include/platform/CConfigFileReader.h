...
namespace TDEngine2
{
	...
	*/
	...
	TDE2_API IFile* CreateConfigFileReader(IMountableStorage* pStorage, TPtr<IStream> pStream, E_RESULT_CODE& result);
	...
	*/
	...
	{
		public:
			friend TDE2_API IFile* CreateConfigFileReader(IMountableStorage*, TPtr<IStream>, E_RESULT_CODE&);
		protected:
