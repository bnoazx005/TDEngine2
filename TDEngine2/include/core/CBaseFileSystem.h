	...
	class CBaseFileSystem : public CBaseObject, public IFileSystem
	{
		...
		public:
			...
			*/
			...
			TDE2_API std::string GetRelativePath(const std::string& inputPath, const std::string& relativeRootPath) override;
#endif
			...
			*/
			...
			TDE2_API std::string GetParentPath(const std::string& path) const override;
