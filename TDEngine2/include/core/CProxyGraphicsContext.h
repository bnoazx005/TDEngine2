...
{
	/*!
		\brief A factory function for creation objects of CProxyGraphicsContext's type
	...
	*/
	...
	/*!
		class CProxyGraphicsContext

		\brief The class is a proxy that's replacement for the graphics context in windowless mode or for testing purposes
	*/
