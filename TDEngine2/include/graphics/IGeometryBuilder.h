	...
	class IGeometryBuilder : public virtual IBaseObject
	{
		...
		public:
			...
			*/
			...
			TDE2_API virtual TGeometryData CreateSolidArcGeometry(const TVector3& position, const TVector3& normal, F32 radius, 
																  F32 fromAngle, F32 toAngle, bool isLooped, F32 width, U16 segmentsCount) = 0;
