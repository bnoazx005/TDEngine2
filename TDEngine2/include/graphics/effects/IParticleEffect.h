...
namespace TDEngine2
{
	...
	*/
	...
	class IParticleEffectLoader : public IGenericResourceLoader<IResourceManager*, IGraphicsContext*, IFileSystem*> {};
	class IParticleEffectFactory : public IGenericResourceFactory<IResourceManager*, IGraphicsContext*> {};
}