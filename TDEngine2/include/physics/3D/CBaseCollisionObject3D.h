...
namespace TDEngine2
{
	/*!
		...
		\brief The class is a base class for all 3D collidable objects that are used in the engine
	*/

	class CBaseCollisionObject3D : public ICollisionObject3D, public CBaseComponent
	{
		public:
			TDE2_REGISTER_COMPONENT_TYPE(CBaseCollisionObject3D)
		...
		protected:
			DECLARE_INTERFACE_IMPL_PROTECTED_MEMBERS(CBaseCollisionObject3D)
		protected:
