...
namespace TDEngine2
{
	...
	*/
	...
	E_RESULT_CODE CBaseTexture2D::Init(IResourceManager* pResourceManager, IGraphicsContext* pGraphicsContext, const std::string& name, const TTexture2DParameters& params)
	{
		...
		createTextureParams.mUsageType = params.mIsReadbackSupported ? E_TEXTURE_IMPL_USAGE_TYPE::DYNAMIC : E_TEXTURE_IMPL_USAGE_TYPE::STATIC;
	...
	bool CBaseTexture2D::IsWriteable() const
	{
