...
namespace TDEngine2
{
	...
	*/
	...
	{
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>({ 0.0f, 1.0f }, { 0.0f, 1.0f }, TVector2{ 100.0f }, { 0.0f, -100.0f }),			///< Top Left
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>(TVector2{ 1.0f }, TVector2{ 1.0f }, TVector2{ 100.0f }, TVector2{ -100.0f }),		///< Top Right
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>(TVector2{ 0.0f }, TVector2{ 0.0f }, TVector2{ 100.0f }, TVector2{ 0.0f }),		///< Bottom Left
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>({ 1.0f, 0.0f }, { 1.0f, 0.0f }, TVector2{ 100.0f }, { -100.0f, 0.0f }),			///< Bottom Right
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>({ 0.0f, 0.5f }, { 0.0f, 0.5f }, TVector2{ 100.0f }, { 0.0f, 0.0f }),				///< Center Left
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>({ 0.5f, 1.0f }, { 0.5f, 1.0f }, TVector2{ 100.0f }, { -50.0f, -100.0f }),			///< Center Top
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>({ 1.0f, 0.5f }, { 1.0f, 0.5f }, TVector2{ 100.0f }, { -100.0f, -50.0f }),			///< Center Right
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>({ 0.5f, 0.0f }, { 0.5f, 0.0f }, TVector2{ 100.0f }, { -50.0f, 0.0f }),			///< Center Bottom
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>(TVector2{ 0.5f }, TVector2{ 0.5f }, TVector2{ 100.0f }, TVector2{ -50.0f }),		///< Center
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>(TVector2{ 0.0f }, { 0.0f, 1.0f }, { 100.0f, 0.0f }, { 0.0f, 0.0f }),				///< Left Wide
		...
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>({ 1.0f, 0.0f }, TVector2{ 1.0f }, { 100.0f, 0.0f }, { -100.0f, 0.0f }),			///< Right Wide
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>({ 0.0f, 1.0f }, TVector2{ 1.0f }, { 0.0f, 100.0f }, { 0.0f, -100.0f }),			///< Top Wide
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>(TVector2{ 0.0f }, { 1.0f, 0.0f }, { 0.0f, 100.0f }, { 0.0f, 0.0f }),				///< Bottom Wide
		std::make_tuple<TVector2, TVector2, TVector2, TVector2>(TVector2{ 0.0f }, TVector2{ 1.0f }, TVector2{ 0.0f }, TVector2{ 0.0f }),			///< Full Rect
	};
