	...
	class CD3D11Mappings
	{
		public:
			...
			*/
			...
			static U32 GetAccessFlags(E_BUFFER_USAGE_TYPE type);
			...
			*/
			...
			static D3D11_USAGE GetUsageType(E_BUFFER_USAGE_TYPE type);
			...
			*/
			...
			static U32 GetFormatSize(E_FORMAT_TYPE format);
			...
			*/
			...
			static std::string GetShaderTargetVerStr(E_SHADER_STAGE_TYPE stageType, E_SHADER_FEATURE_LEVEL version);
			...
			*/
			...
			static const C8* GetSemanticTypeName(E_VERTEX_ELEMENT_SEMANTIC_TYPE semanticType);
			...
			*/
			...
			static D3D11_PRIMITIVE_TOPOLOGY GetPrimitiveTopology(E_PRIMITIVE_TOPOLOGY_TYPE topologyType);
			...
			*/
			...
			static D3D11_FILTER GetFilterType(E_TEXTURE_FILTER_TYPE filterValue);
			...
			*/
			...
			static D3D11_TEXTURE_ADDRESS_MODE GetTextureAddressMode(E_ADDRESS_MODE_TYPE addressMode);
			...
			*/
			...
			static D3D11_BLEND GetBlendFactorValue(E_BLEND_FACTOR_VALUE factor);
			...
			*/
			...
			static D3D11_BLEND_OP GetBlendOpType(E_BLEND_OP_TYPE opType);
			...
			*/
			...
			static D3D11_TEXTURECUBE_FACE GetCubemapFace(E_CUBEMAP_FACE faceType);
			...
			*/
			...
			static D3D11_COMPARISON_FUNC GetComparisonFunc(const E_COMPARISON_FUNC& func);
			...
			*/
			...
			static D3D11_STENCIL_OP GetStencilOpType(const E_STENCIL_OP& stencilOp);
			...
			*/
			...
			static D3D11_CULL_MODE GetCullMode(const E_CULL_MODE& cullMode);
	};
}
