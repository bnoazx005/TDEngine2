...
namespace TDEngine2
{
	...
	class CD3D11GraphicsContext : public IGraphicsContext, public IEventHandler, public CBaseObject
	{
		...
		public:
			...
			*/
			...
			TDE2_API E_RESULT_CODE SetTexture(U32 slot, TTextureHandleId textureHandle, bool isWriteEnabled = false, const std::optional<U32>& subresourceId = std::nullopt) override;
	...
	E_RESULT_CODE CD3D11GraphicsContext::SetTexture(U32 slot, TTextureHandleId textureHandle, bool isWriteEnabled, const std::optional<U32>& subresourceId)
	{
	...
	void CD3D11GraphicsContext::MemoryAccessBarrier(const std::variant<TBufferHandleId, TTextureHandleId> resourceHandle)
	{
	}
	...
	void CD3D11GraphicsContext::DebugBarrier()
	{
