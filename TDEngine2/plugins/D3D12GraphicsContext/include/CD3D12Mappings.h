...
namespace TDEngine2
{
	class CD3D12Mappings
	{
		public:
			...
			//	\return A value of D3D12_USAGE type
			//*/
			...
			/*!
				\brief The function maps internal engine topology's type into Direct3D12 specific value

				\param[in] topologyType An internal engine representation of a primitive topology

				\return A primitive topology's value which is D3D12 specific
			*/

			static D3D12_PRIMITIVE_TOPOLOGY GetPrimitiveTopology(E_PRIMITIVE_TOPOLOGY_TYPE topologyType);
