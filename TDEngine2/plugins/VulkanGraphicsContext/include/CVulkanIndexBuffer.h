...
namespace TDEngine2
{
	...
	/*!
		...
		\brief The class implements a functionality of a hardware index buffer for Vulkan GAPI
	*/


	class CVulkanIndexBuffer : public IIndexBuffer, public CBaseObject
	{
		public:
			friend TDE2_API IIndexBuffer* CreateVulkanIndexBuffer(IGraphicsContext*, E_BUFFER_USAGE_TYPE, E_INDEX_FORMAT_TYPE, USIZE, const void*, E_RESULT_CODE&);
		public:
			/*!
		...
		protected:
			DECLARE_INTERFACE_IMPL_PROTECTED_MEMBERS(CVulkanIndexBuffer)
	...
	/*!
		\brief A factory function for creation objects of CVulkanIndexBuffer's type

		\return A pointer to CVulkanIndexBuffer's implementation
	*/
