...
namespace TDEngine2
{
	...
	*/
	...
	class CVulkanVertexBuffer : public IVertexBuffer, public CBaseObject
	{
		public:
			friend TDE2_API IVertexBuffer* CreateVulkanVertexBuffer(IGraphicsContext*, E_BUFFER_USAGE_TYPE, USIZE, const void*, E_RESULT_CODE&);
		public:
			/*!
		...
		protected:
			DECLARE_INTERFACE_IMPL_PROTECTED_MEMBERS(CVulkanVertexBuffer)
	...
	/*!
		\brief A factory function for creation objects of CVulkanVertexBuffer's type

		\return A pointer to CVulkanVertexBuffer's implementation
	*/
