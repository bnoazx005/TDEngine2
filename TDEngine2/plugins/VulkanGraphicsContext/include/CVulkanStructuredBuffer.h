/*!
	\file CVulkanStructuredBuffer.h
	\date 07.11.2023
...
namespace TDEngine2
{
	...
	/*!
		\brief A factory function for creation objects of CVulkanStructuredBuffer's type

		\return A pointer to CVulkanStructuredBuffer's implementation
	*/
	...
	/*!
		class CVulkanStructuredBuffer

		\brief The class implements a functionality of a hardware SSBOs for Vulkan GAPI
	*/


	class CVulkanStructuredBuffer : public IStructuredBuffer, public CBaseObject
	{
		public:
			friend TDE2_API IStructuredBuffer* CreateVulkanStructuredBuffer(const TStructuredBuffersInitParams&, E_RESULT_CODE&);
		public:
			/*!
		...
		protected:
			DECLARE_INTERFACE_IMPL_PROTECTED_MEMBERS(CVulkanStructuredBuffer)
