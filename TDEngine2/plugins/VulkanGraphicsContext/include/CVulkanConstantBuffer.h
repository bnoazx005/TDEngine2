...
namespace TDEngine2
{
	...
	/*!
		class CVulkanConstantBuffer

		\brief The class implements a functionality of a hardware uniform buffer for Vulkan GAPI
	*/


	class CVulkanConstantBuffer : public IConstantBuffer, public CBaseObject
	{
		public:
			friend TDE2_API IConstantBuffer* CreateVulkanConstantBuffer(IGraphicsContext*, E_BUFFER_USAGE_TYPE, USIZE, const void*, E_RESULT_CODE&);
		public:
			/*!
		...
		protected:
			DECLARE_INTERFACE_IMPL_PROTECTED_MEMBERS(CVulkanConstantBuffer)
	...
	/*!
		\brief A factory function for creation objects of CVulkanConstantBuffer's type

		\return A pointer to CVulkanConstantBuffer's implementation
	*/
